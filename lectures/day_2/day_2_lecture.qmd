...
* If you are really polishing, you might want to use a color design system
...
* We will also explore the use of the `viridis` package, which provides perceptually uniform, colorblind-friendly options
